                            ...
                            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div className="row nav-orange p-2" style={{borderBottomLeftRadius:"50px"}}>
                                    <div className="col-lg-2 col-md-6 col-sm-6 col-xs-6 my-auto text-white contact-num">
                                        <img src={`${process.env.PUBLIC_URL}/assets/phone.svg`} width="25" alt="phone-icon"/> <span>+91 9293858689</span>
                                    </div>
                                    <div className="col-lg-2 col-md-6 col-sm-6 col-xs-6 my-auto text-white contact-mail">
                                        <img src={`${process.env.PUBLIC_URL}/assets/email.svg`} width="25" alt="email-icon"/> <span>info@feedorg.com</span>
                                    </div>
                                    ...
                                    <div className="col-lg-2 col-md-4 col-sm-1 col-xs-1 col">
                                        <button className="btn btn-primary download-btn form-control"><i className="fa fa-download" aria-hidden="true"></i> <span className="download-btn-text">Downloads</span></button>
                                    </div>
                                    ...
                                    <div className="col-lg-2 col-md-4 col-sm-4 col-xs-4 col my-auto header-social-icons">
                                        <a href=""><img src={`${process.env.PUBLIC_URL}/assets/facebook.svg`} width="30" alt="facebook-icon"/></a>
                                        <a href=""><img src={`${process.env.PUBLIC_URL}/assets/instagram.svg`} width="30" alt="instagram-icon"/></a>
                                        <a href=""><img src={`${process.env.PUBLIC_URL}/assets/twitter.svg`} width="30" alt="twitter-icon"/></a>
                                        <a href=""><img src={`${process.env.PUBLIC_URL}/assets/linkedin.svg`} width="30" alt="linkedin-icon"/></a>
                                        <a href=""><img src={`${process.env.PUBLIC_URL}/assets/youtube.svg`} width="30" alt="youtube-icon"/></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <nav className="navbar navbar-expand-lg nav-list">
                                    ...
                                    <div className="collapse navbar-collapse" id="navbarNav">
                                        <ul className="navbar-nav">
                                            ...
                                            <li className="nav-item">
                                                <a className="nav-link" href="#feedServices">Services</a>
                                            </li>
                                            <li className="nav-item">
                                                <a className="nav-link" href="#eventsUpdates">Events</a>
                                            </li>
                                            <li className="nav-item">
                                                <a className="nav-link" href="#howFeedWorks">How Feed Works</a>
                                            </li>
                                            <li className="nav-item">
                                                <a className="nav-link" href="#">FPO</a>
                                            </li>
                                            <li className="nav-item">
