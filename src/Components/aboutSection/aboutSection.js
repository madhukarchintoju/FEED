                ...
                <div className="row">
                  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 aboutus-content">
                    <p>
                      ...
                      type specimen book standard dummy text ever since the
              ...
              <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div className="row">
                  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 objective-content-wrap">
                    ...
                    <p className="objective-content">
                      ...
                      remaining essentially unchanged Lorem Ipsum has been the
                ...
                <div className="row">
                  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    >
                      <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div className="card vision-card text-center">
                          ...
                          <div className="card-body p-2">
                            <p className="card-text vision-content">
                              ...
                              elit. Nam eu sem tempor, varius quam at, luctus
                              dui. Mauris magna metus, dapibus nec turpis vel,
                              semper malesuada ante.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div className="card mission-card text-center">
                          ...
                          <div className="card-body p-2">
                            <p className="card-text mission-content">
                              Lorem ipsum dolor sit amet, consectetur adipiscing
                              elit. Nam eu sem tempor, varius quam at, luctus
                              dui. Mauris magna metus, dapibus nec turpis vel,
                              semper malesuada ante.
